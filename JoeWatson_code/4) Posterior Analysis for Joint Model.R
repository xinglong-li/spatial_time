# Analysis of the final joint PS model #
...
# Plot the number of sites vs year #
no_sites_year = colSums(!is.na(BlackSmokePrefData[,-c(1,2,3)]))
no_sites_df = data.frame(y = no_sites_year, x = 66:96)
no_sites_plot = ggplot(no_sites_df, aes(x = x, y = y)) +
  geom_line() + geom_smooth() +
  ggtitle('A plot of the number of operating sites vs. year') +
